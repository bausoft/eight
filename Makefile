...
# Generated by qmake (2.01a) (Qt 4.8.5) on: Thu Jan 2 21:09:36 2014
# Project:  8coin-qt.pro
# Template: app
# Command: /opt/local/bin/qmake USE_UPNP=- -o Makefile 8coin-qt.pro
#############################################################################
...
CFLAGS        = -pipe -msse2 -O2 -arch x86_64 -Xarch_x86_64 -mmacosx-version-min=10.8 -Wall -W $(DEFINES)
CXXFLAGS      = -pipe -fstack-protector-all --param ssp-buffer-size=1 -msse2 -O2 -arch x86_64 -Xarch_x86_64 -mmacosx-version-min=10.8 -fdiagnostics-show-option -Wall -Wextra -Wformat -Wformat-security -Wno-unused-parameter -Wstack-protector $(DEFINES)
...
LINK          = /usr/bin/clang++
LFLAGS        = -headerpad_max_install_names -fstack-protector-all --param ssp-buffer-size=1 -arch x86_64 -Xarch_x86_64 -mmacosx-version-min=10.8
LIBS          = $(SUBLIBS) -F/opt/local/Library/Frameworks -F/opt/local/lib  -framework Foundation -framework ApplicationServices -framework AppKit -L/opt/local/lib -L/opt/local/lib/db48 -lssl -lcrypto -ldb_cxx-4.8 -lboost_system-mt -lboost_filesystem-mt -lboost_program_options-mt -lboost_thread-mt -F/opt/local/Library/Frameworks -F/opt/local/lib -framework QtGui -framework QtCore 
AR            = ar cq
RANLIB        = ranlib -s
...
Makefile: 8coin-qt.pro  /opt/local/share/qt4/mkspecs/macx-g++/qmake.conf /opt/local/share/qt4/mkspecs/common/unix.conf \
	...
	$(QMAKE) USE_UPNP=- -o Makefile 8coin-qt.pro
...
Decayscript-Qt.app/Contents/Info.plist: 
	...
	@sed -e "s,@SHORT_VERSION@,0.7,g" -e "s,@TYPEINFO@,????,g" -e "s,@ICON@,bitcoin.icns,g" -e "s,@EXECUTABLE@,Decayscript-Qt,g" -e "s,@TYPEINFO@,????,g" /opt/local/share/qt4/mkspecs/macx-g++/Info.plist.app >Decayscript-Qt.app/Contents/Info.plist
...
/Users/eze/8coin/build/build.h: FORCE
	cd /Users/eze/8coin; /bin/sh share/genbuild.sh /Users/eze/8coin/build/build.h
